...
function mascotSVG(state){
  ...
  const mouth = state==='sleep'
    ? `<path d="M28 39 q4 1.5 8 0" stroke="#08111F" stroke-width="1.6" fill="none" stroke-linecap="round"/>`
    : (state==='speaking'||state==='celebration'||state==='success')
      ? `<ellipse cx="32" cy="38" rx="4.5" ry="3" fill="#08111F" opacity="0.75"/>`
      : `<path d="M25 36 q7 6 14 0" stroke="#08111F" stroke-width="2.2" fill="none" stroke-linecap="round"/>`;
  return `<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
    ...
    <g class="${bodyBob}">
      ...
      ${state==='sleep' ?
        `<path d="M23 30 q3 -2 6 0" stroke="#08111F" stroke-width="2" fill="none" stroke-linecap="round"/><path d="M35 30 q3 -2 6 0" stroke="#08111F" stroke-width="2" fill="none" stroke-linecap="round"/>`
        :
        `<circle cx="26" cy="${eyeY}" r="3.2" fill="#08111F"/><circle cx="38" cy="${eyeY}" r="3.2" fill="#08111F"/><circle cx="27" cy="${eyeY-1.2}" r="1.1" fill="#00E5FF"/><circle cx="39" cy="${eyeY-1.2}" r="1.1" fill="#00E5FF"/>`
      }
      ${mouth}
    </g>
