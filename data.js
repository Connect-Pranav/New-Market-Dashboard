...
/* ---------------------------------------------------------------
   ADDITIONAL SCANNER MOCK DATA (Opportunity Dashboard expansion)
--------------------------------------------------------------- */
const SCANNER_BREAKOUT=[
  {n:'POLYCAB',price:'₹6,820',chg:'+4.2%',note:'Broke above 6-month resistance on volume'},
  {n:'VINDHYATEL',price:'₹612',chg:'+6.8%',note:'New 52-week high breakout with rising volume'},
  {n:'TRIVENI',price:'₹398',chg:'+3.5%',note:'Cleared consolidation range from past 8 weeks'},
  {n:'ZENTEC',price:'₹1,840',chg:'+5.1%',note:'Breakout above descending trendline'}
];
const SCANNER_VOLUME_SURGE=[
  {n:'TATVA',price:'₹1,120',volRatio:'4.2x',note:'Volume 4.2x the 20-day average'},
  {n:'TIPSFILMS',price:'₹612',volRatio:'3.6x',note:'Unusual volume spike post block deal'},
  {n:'SHRIRAMFIN',price:'₹3,140',volRatio:'2.9x',note:'Elevated volume ahead of result date'},
  {n:'HYUNDAI',price:'₹1,890',volRatio:'2.4x',note:'Volume pickup on sector-wide interest'}
];
const SCANNER_52WK_HIGH=[
  {n:'VINDHYATEL',price:'₹612',pctFromHigh:'0.0%',note:'At fresh 52-week high'},
  {n:'SBILIFE',price:'₹1,706',pctFromHigh:'-1.2%',note:'Within 2% of 52-week high'},
  {n:'TRIVENI',price:'₹398',pctFromHigh:'-0.8%',note:'Within 1% of 52-week high'},
  {n:'INDIAMART',price:'₹2,840',pctFromHigh:'-3.4%',note:'Approaching 52-week high zone'}
];
const SCANNER_MOMENTUM=[
  {n:'VINDHYATEL',price:'₹612',rsi:74,note:'Strong momentum, RSI in upper band'},
  {n:'POLYCAB',price:'₹6,820',rsi:68,note:'Sustained price momentum over 3 months'},
  {n:'SBILIFE',price:'₹1,706',rsi:64,note:'Improving momentum on earnings strength'},
  {n:'ZENTEC',price:'₹1,840',rsi:71,note:'Momentum building post breakout'}
];
const THEME_SCANNERS={
  growth:{label:'Growth Stocks',tickers:['VINDHYATEL','TRIVENI','ZENTEC','TATVA','TIPSFILMS'],note:'Companies with the strongest revenue and profit growth trajectories.'},
  value:{label:'Value Stocks',tickers:['GICRE','SHRIRAMFIN','HYUNDAI','TCS'],note:'Companies trading at relatively modest valuation multiples.'},
  turnaround:{label:'Turnaround Stories',tickers:['TORNTPOWER','WIPRO','PATANJALI'],note:'Companies showing early signs of operational improvement.'},
  emerging:{label:'Emerging Themes',tickers:['VINDHYATEL','ZENTEC','TATVA'],note:'Companies positioned around emerging structural themes (telecom equipment, specialty chemicals, IT niches).'}
};
